...
name: Luisa M.
surname: Mimmi
position: Economist & EU Funds Analyst #"Economista & Analista di Politiche Pubbliche"
...
aboutme: |-
  Experienced policy analyst with a strong background in statistical and econometric analysis applied to economic development. I have evaluated policies and financial instruments pursuing equitable and sustainable access to infrastructure services (housing, mobilitym water and sanitation, energy, education and health).  
  I am currently pursuing opportunities to apply my policy analysis and project management skills in the field of national/EU Structural and Investment Funds (ERDF, ESF, CF, Next Generatin EU, PNRR, etc). 
...
courses %>% 
  filter(year > 2017) %>% # mainly to stick to 2 pg 
  vitae::detailed_entries(
    #why = area ,
    what = accomplishment,
    when = year ,
