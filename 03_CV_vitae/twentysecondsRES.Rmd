...
tibble::tribble(~name, ~date, ~description , ~link,
  ...
  "Personal Blog",   '2018/2019', "Side projects, R code, miscellaneous thoughts...", "\\href{https://luisamimmi.com/}{https://luisamimmi.com/}" ,

  "Green Card processing time under Trump", "2019", "Analysis of public US data",
  "\\href{https://luisamimmi.com/post/2019/07/07/green-card-processing-time/}{https://luisamimmi.com/post/2019/07/07/green-card-processing-time/}" ,

  "New York Encounter's Donors", "2019", "Fundraising data analysis",
  "\\href{https://luisamimmi.com/post/2019/04/14/nye-fundraising-data-analysis/}{https://luisamimmi.com/post/2019/04/14/nye-fundraising-data-analysis/}" ,
