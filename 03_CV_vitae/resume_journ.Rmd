...
aboutme: |-
  I am an economist by training with demonstrated expertise designing and implementing diagnostic tools, advanced analytics and data visualizations applied to economic development. I have investigated different policies and financial tools to improve universal access to infrastructure services (housing, water and sanitation, energy, education and health). 
    A life-long learner, I am passionate about using data from different sources –including social media, GIS and satellite imagery– to understand and tackle complex public policy issues. 
