...
params:
  ...
  jobtitle:
    label: Job Title
    value: "Policy Analyst - Infrastructure & Development Economics"
    input: select
    choices: ["Policy Analyst - Infrastructure & Development Economics", "Policy & Data Analyst"]
  blurb:
      label: Short Bio
...
•	*Independent Consulting - based in Italy*
 ...
 >  Currently providing consultancy services to the Italian government (on resilient infrastructure policies) and to a Milan-based think-tank (on water scarcity issues and regulation).
...
**Mimmi L.M.**. 2022 (Under Review) *‘Caution: road work ahead’: Italy in front of the challenge of infrastructure maintenance: existing issues and promising responses*.
