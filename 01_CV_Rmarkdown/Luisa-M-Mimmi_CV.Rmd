...
> Experienced Policy Analyst with a strong background in statistical and econometric analysis applied to economic development. 
My work focuses on understanding the challenges and identifying the priorities to alleviate poverty and promote universal access to basic services (housing, water and sanitation, energy, education and health). My core technical skills are designing and implementing surveys, statistical analyses and impact evaluations, but I have also demonstrated leadership and resourcefulness in project management roles. As a life-long learner, I am passionate about exploring new tools and data sources to uncover various dimensions of poverty and inequality. \hfill



# WORK

•	*Inter-American Development Bank (Infrastructure - Water Div.):*
...
•	*World Bank (Sustainable Development - two Multilateral Trust Funds):*
...
•	*Inter-American Development Bank (Social Protection & Health Div.):*
...
•	*AVSI (Social Inclusion and Education) - in Brazil:*
...
Mimmi, L.M. July 9, 2019 “*s President Trump holding on to his electoral promiseto“hire American”?*” . [Personal Blog](https://lulliter.github.io/project/GreenCard_Article.pdf) 
...
Mimmi, L.M. 2016. “*Open Spatial Data for Resilience in Tanzania: Lessons Learned from ‘Dar Ramani Huria.’*" November 15, 2016. [Personal Blog](https://lulliter.github.io/post/2016-11-15_ramani-huria/) 

Mimmi, L.M. 2009. “*Sussidiarietà e Sviluppo: L’elettricità nelle _Favelas_ dell’America Latina.*” February 28, 2009. (in Italian) [Personal Blog](https://lulliter.github.io/post/sussidiariet%C3%A0-e-sviluppo/).
